::mods_hookExactClass("skills/effects/bleeding_effect", function ( o )
{
	...
	o.applyDamage = function ()
	{
		if (this.m.LastRoundApplied != this.Time.getRound())
		{
			...
			hitInfo.DamageRegular = this.m.Damage * (actor.getSkills().hasSkill("effects.hyena_potion") ? 0.5 : 1.0) * (actor.getSkills().hasSkill("perk.crresilient") ? 0.75 : 1.0) * (actor.getSkills().hasSkill("effects.rogue_special_01") ? 0.5 : 1.0);
