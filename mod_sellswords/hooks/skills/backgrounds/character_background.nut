::mods_hookExactClass("skills/backgrounds/character_background", function ( o )
{
	...
	o.calculateAdditionalRecruitmentLevels = function ()
	{
		...
		if (::Legends.Mod.ModSettings.getSetting("RecruitScaling").getValue() && !::Legends.Mod.ModSettings.getSetting("RogueMode").getValue())
		{
			if (avgLevel < 7)
			{
				return 0;				
		...
		else if (::Legends.Mod.ModSettings.getSetting("RogueMode").getValue())
		{
			return this.Math.max(0, avgLevel - 1);
		}
		else
		{
			return 0;
