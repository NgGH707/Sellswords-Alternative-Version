...
::Const.LegendMod.FavoriteArcher.extend([
	this.Const.EntityType.crSellswordranger,
...
::Const.LegendMod.FavoriteBarbarian.extend([
	...
	this.Const.EntityType.BarbarianKuangzhanshi,
	this.Const.EntityType.BarbarianKuangzhanshi02,
...
::Const.LegendMod.FavoriteBandit.extend([
	this.Const.EntityType.crDesperado,
	this.Const.EntityType.crDesperadoLOW,
	this.Const.EntityType.crDesperadoverylow,
...
::Const.LegendMod.FavoriteMercenary.extend([
	...
	this.Const.EntityType.crSellsword,
	this.Const.EntityType.crHedgeKnight,
	this.Const.EntityType.crSellsword_pol,
	this.Const.EntityType.crSellsword_tank,
	this.Const.EntityType.crSellswordsergeant,
	this.Const.EntityType.crSellswordstandardbearer,
	this.Const.EntityType.crSellswordranger,
...
::Const.LegendMod.FavoriteNomad.extend([
	...
	this.Const.EntityType.PeasantSouthern,
	this.Const.EntityType.crHashshashin,
	this.Const.EntityType.crHashshashinLOW,	
	this.Const.EntityType.crOutlander	
]);
...
::Const.LegendMod.GetFavoriteEnemyValue = function ( _type )
{
	...
	case "this.Const.EntityType.crSellswordranger":
	case "this.Const.EntityType.crSellsword_pol":
	case "this.Const.EntityType.crSellswordveteran_tank":	
	case "this.Const.EntityType.crSellsword_pol":
	case "this.Const.EntityType.crSellswordsergeant":		
	case "this.Const.EntityType.crSellswordstandardbearer":	
	...
	case "this.Const.EntityType.BarbarianKuangzhanshi02":
