::mods_hookNewObject("ui/screens/tooltip/tooltip_events", function(o) {
	...
	o.general_queryUIElementTooltipData = function( _entityId, _elementId, _elementOwner )
	{
		...
		case "world-town-screen.main-dialog-module.Arena":
			...
			if (this.World.Contracts.getActiveContract() != null && this.World.Contracts.getActiveContract().getType() != "contract.arena" && this.World.Contracts.getActiveContract().getType() != "contract.arena_tournament" && this.World.Contracts.getActiveContract().getType() != "contract.cr_rogue_arena")
			{
				ret.push({
					id = 3,
					type = "hint",
