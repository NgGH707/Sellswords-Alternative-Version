::mods_hookExactClass("items/ammo/legend_large_broad_head_bolts", function ( o )
{
	...
	o.create = function()
	{
		...
		this.m.Description = "A large quiver of bolts with broad tips, designed for tearing flesh, but easily stopped by armor. Is automatically refilled after each battle if you have enough global ammunition. Grants +20% hitpoints damage but has a -10% modification apply to both armor piercing damage and damage against armor while wielding a crossbow.";
	}
