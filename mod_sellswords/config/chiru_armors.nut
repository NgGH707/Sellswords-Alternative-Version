::Const.LegendMod.ArmorObjs.extend([{
		...
		Sets = [
			{
				...
				Plate = [
					[1, "plate/named_plated_fur_armor"],// 150_165,-18_-15				
				],
				Cloak = [],
				Tabard = [],
				Attachments = []
		...
		Sets = [
			{
				...
				Plate = [
					[1, "plate/named_skull_and_chain_armor"],// 185_200,-21_-19				
				],
				Cloak = [],
				Tabard = [],
				Attachments = []
		...
		Sets = [
			{
				...
				Plate = [
					[1, "plate/named_bronze_armor"],// 250_265,-28_-25				
				],
				Cloak = [],
				Tabard = [],
				Attachments = [
		...
		Sets = [
			{
				...
				Plate = [
					[1, "plate/named_bronze_armor"],// 240_265,-31_-28					
				],
				Cloak = [],
				Tabard = [],
				Attachments = [
	...
	{
		ID = "cr_rogue_barbarian_reward_armor",   //205,-29  -> 295,-43    
		Script = "",
		Sets = [
			{
				Cloth = [                               
					[0, "cloth/legend_sackcloth_patched"],// 15,-1,25
					[1, "cloth/legend_padded_surcoat"],// 55,-6					
				],
				Chain = [
					[0, "chain/legend_armor_mail_shirt"],// 50,-6,375
					[1, "chain/legend_armor_hauberk_sleevless"],// 65,-7				
				],
				Plate = [
					[0, "plate/legend_heavy_iron_armor"],// 120,-18,1000
					[1, "plate/legend_thick_plated_barbarian_armor"], // 155,-26,1500						
				],
				Cloak = [],
				Tabard = [],
