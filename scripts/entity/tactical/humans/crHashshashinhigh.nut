this.crHashshashinhigh <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.crHashshashinhigh;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.crHashshashinhigh.XP;
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crHashshashinhigh);
