this.crDesperadohigh <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.crDesperadohigh;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.crDesperadohigh.XP;
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crDesperadohigh);
