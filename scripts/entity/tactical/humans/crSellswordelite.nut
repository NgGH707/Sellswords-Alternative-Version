this.crSellswordelite <- this.inherit("scripts/entity/tactical/human", {
	m = {
		IsLow = false
	},
	function create()
	{
		this.m.Type = this.Const.EntityType.crSellswordelite;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.crSellswordelite.XP;
	...
	{
		return this.Const.Strings.crSellswordEliteNames[this.Math.rand(0, this.Const.Strings.crSellswordEliteNames.len() - 1)];
	}	
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crSellswordelite);
		...
		this.m.Skills.add(this.new("scripts/skills/racial/cr_rogue_champion_racial"));			
	}
