this.barbarian_kuangzhanshi02 <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.BarbarianKuangzhanshi02;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.BarbarianKuangzhanshi02.XP;
		this.human.create();
		...
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/kuangzhanshi_agent");
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.BarbarianKuangzhanshi02);
	...
	function assignRandomEquipment()
	{
		...
		{
			local weapons = [
				"weapons/kuangzhanshishuangfu02",
				"weapons/kuangzhanshishuangfu02",
				"weapons/kuangzhanshishuangfu03",				
				"weapons/kuangzhanshishuangfu03",				
				"weapons/kuangzhanshishuangkandao",	
				"weapons/kuangzhanshishuangkandao02",
				"weapons/kuangzhanshishuangkandao02",
				"weapons/kuangzhanshishuangkandao02",				
