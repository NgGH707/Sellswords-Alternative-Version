...
gt.Const.World.Spawn.CaravanwithSellswords <- {
...
gt.Const.World.Spawn.Noblewithbaron <- {
	Name = "Noblewithbaron",
	IsDynamic = true,
...
gt.Const.World.Spawn.NobleCaravanwithSellswords <- {
...
gt.Const.World.Spawn.CaravanSouthernwithSellswords <- {
...
gt.Const.World.Spawn.Desperados <- {
	Name = "Desperados",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
	...
	Troops = [
		{
			...
			Types = [
				{
					Type = this.Const.World.Spawn.Troops.crDesperadoverylow,
					Cost = 18
				}
			]
		},
		{
			...
			Types = [
				{
					Type = this.Const.World.Spawn.Troops.crDesperadoLOW,
					Cost = 30
				}
			]
		},		
...
gt.Const.World.Spawn.Hashshashins <- {
	Name = "Hashshashins",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
	...
	Troops = [
		{
			...
			Types = [
				{
					Type = this.Const.World.Spawn.Troops.crHashshashinLOW,
					Cost = 25
				}
			]
		},
		...
		},		
		{
			...
			Types = [
				{
					Type = this.Const.World.Spawn.Troops.crHashshashinhigh,
					Cost = 75
				}
			]
		}		
...
gt.Const.World.Spawn.BabarianBerserkers <- {
...
gt.Const.World.Spawn.Barbhunters <- {
	Name = "Barbhunters",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
...
gt.Const.World.Spawn.BabarianChosens <- {
...
gt.Const.World.Spawn.BabarianChosenswithKing <- {
...
gt.Const.World.Spawn.crthieves <- {
	Name = "crthieves",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
...
gt.Const.World.Spawn.RomaLegion <- {
	Name = "RomaLegion",
	IsDynamic = true,
...
gt.Const.World.Spawn.BanditMilitary <- {
	Name = "BanditMilitary",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
...
gt.Const.World.Spawn.BarbarianMilitary <- {
...
gt.Const.World.Spawn.NomadMilitary <- {
	Name = "NomadMilitary",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
...
gt.Const.World.Spawn.ZombieMilitary <- {
	Name = "ZombieMilitary",
	IsDynamic = true,
...
gt.Const.World.Spawn.Manhunters <- {
	Name = "Manhunters",
	IsDynamic = true,
	MovementSpeedMult = 0.8,
	VisibilityMult = 1.0,
...
gt.Const.World.Spawn.SAEbandits <- {
	Name = "SAEbandits",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
...
gt.Const.World.Spawn.SAEassasins <- {
	Name = "SAEassasins",
	IsDynamic = true,
	MovementSpeedMult = 1.0,
	VisibilityMult = 1.0,
