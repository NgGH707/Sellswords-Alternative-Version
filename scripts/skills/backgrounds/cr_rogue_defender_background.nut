this.cr_rogue_defender_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},
	function create()
	{
		this.character_background.create();
		this.m.ID = "background.cr_rogue_defender";
		this.m.Name = "Operator";
		this.m.Icon = "ui/backgrounds/background_rogue_04.png";
