this.cr_rogue_specialist_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},
	function create()
	{
		this.character_background.create();
		this.m.ID = "background.cr_rogue_specialist";
		this.m.Name = "Operator";
		this.m.Icon = "ui/backgrounds/background_rogue_03.png";
