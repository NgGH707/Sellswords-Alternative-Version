this.fangxuezhe_01 <- this.inherit("scripts/skills/skill", {
	m = {
		SoundsA = [
	...
	function create()
	{
		this.m.ID = "actives.fangxuezhe_01";
		this.m.Name = "Execute";
		this.m.Description = "Use this serrated axe to slash an enemy mercilessly, leaving the victim bleeding profusely.";
