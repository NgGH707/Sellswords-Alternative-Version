this.kuangzhanshishuangkandao01_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.kuangzhanshishuangkandao01_02";
		this.m.Name = "Mince";
		...
		ret.extend([
			{
				...
				text = "Will make five separate strikes for 40% of the weapon\'s damage each"
			},
			{
				id = 8,
				type = "text",
				icon = "ui/icons/special.png",
				text = "Has a higher chance to cause fatalities"
			}			
		]);
		return ret;
	}
