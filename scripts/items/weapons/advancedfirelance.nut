this.advancedfirelance <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Description = "An experimental spear of southern design with multiple explosive charges that will spew fire over two tiles when ignited. This more advanced design can be used up to 4 times per battle and is automatically refilled after.";
