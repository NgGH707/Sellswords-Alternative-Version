this.cr_rogue_cleaver <- this.inherit("scripts/items/weapons/weapon", {
	m = {},
	function create()
	{
		this.weapon.create();
		this.m.ID = "weapon.cr_rogue_cleaver";
		this.m.Name = "Slave Owner's Two-Handed Scimitar";
		this.m.Description = "A large scimitar wielded with both hands. The curved blade cleaves right through any enemy.";
		this.m.IconLarge = "weapons/melee/two_handed_scimitar_01_named_01.png";
		this.m.Icon = "weapons/melee/two_handed_scimitar_01_named_01_70x70.png";
		...
		this.m.ArmamentIcon = "icon_two_handed_scimitar_01_named_01";
		this.m.Value = 3000;
